...
namespace Sol.Water
{
    ...
    {
        /// <summary>
        /// Readback grid size per cascade. Against the current cascade domains
        /// (see <see cref="CascadeSize"/>) that is roughly 8 cm on the shortest and 9 m
        /// on the longest — finer than any hull that needs buoyancy on the scales that
        /// carry it, and two orders of magnitude cheaper than reading back the full
        /// simulation.
        ///
        /// The earlier note here quoted a 32 m shortest cascade and a resulting half
        /// metre per texel. That was the pre-2026 domain table; the domains moved and
        /// this did not.
        /// </summary>
