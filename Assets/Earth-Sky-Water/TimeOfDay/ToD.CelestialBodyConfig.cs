...
namespace Sol.ToD
{
 ...
 [Tooltip("Starting orbital phase (0-1). Controls where in its orbit the body begins.")]
        ...
        [Tooltip("Optional full-disc surface texture (e.g. a moon face photo). Multiplies the lit color. Leave null for a flat-colored disc.")]
        public Texture2D surfaceTexture;

        [Tooltip("Rotation of the surface texture on the disc, in degrees.")]
        [Range(0f, 360f)]
        public float surfaceRotation = 0f;
