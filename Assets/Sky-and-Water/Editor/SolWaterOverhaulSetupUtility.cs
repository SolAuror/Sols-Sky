...
public static class SolWaterOverhaulSetupUtility
{
    ...
    const string DemoPath = "Assets/Sky-and-Water/Demo";
    const string OceanShaderPath = "Assets/Sky-and-Water/Resources/Water2/SolOcean.shader";
    const string ResolveShaderPath = "Assets/Sky-and-Water/Resources/Water2/SolWaterResolve.shader";
    const string UnderwaterShaderPath = "Assets/Sky-and-Water/Resources/Water2/SolUnderwater.shader";
    const string FftShaderPath = "Assets/Sky-and-Water/Resources/Water2/SolWaterFFT.compute";
    ...
    const int ShorelineBakeResolution = 512;
    ...
    public static void InstallRendererFeature()
    {
        ...
        featureObject.FindProperty("oceanShader").objectReferenceValue =
            AssetDatabase.LoadAssetAtPath<Shader>(OceanShaderPath);
        featureObject.FindProperty("resolveShader").objectReferenceValue =
            AssetDatabase.LoadAssetAtPath<Shader>(ResolveShaderPath);
        featureObject.FindProperty("underwaterShader").objectReferenceValue =
            AssetDatabase.LoadAssetAtPath<Shader>(UnderwaterShaderPath);
        featureObject.FindProperty("fftShader").objectReferenceValue =
            AssetDatabase.LoadAssetAtPath<ComputeShader>(FftShaderPath);
    ...
    static void EnsureFolders()
    {
        ...
        EnsureFolder("Assets/Sky-and-Water", "Demo");
    }
