...
public sealed class SolRainVfxController : MonoBehaviour
{
    ...
    [SerializeField] UnderwaterVolumeController underwaterController;
    ...
    void Update()
    {
        ...
        float underwaterExposure = underwaterController != null && underwaterController.IsUnderwater ? 0f : 1f;
    ...
    void ResolveReferences()
    {
        ...
        if (_referenceRetryTimer > 0f &&
            (weatherManager == null || timeOfDay == null || underwaterController == null))
            return;

        bool missingReference = weatherManager == null || timeOfDay == null || underwaterController == null;
        weatherManager ??= SolWeatherManager.Instance;
        timeOfDay ??= TimeOfDay.ResolveInstance();
        underwaterController ??= FindFirstObjectByType<UnderwaterVolumeController>();
        ...
        if (missingReference && (weatherManager == null || timeOfDay == null || underwaterController == null))
    ...
    void EnsureSystems()
    {
        ...
        if (_runtimeMaterial == null)
        {
            ...
            {
                Shader shader = Resources.Load<Shader>("SolRainParticle");
