...
namespace Sol.Water.Rendering
{
    ...
    internal sealed class SolOceanClipmap : IDisposable
    {
        ...
        internal DrawSet Build(Camera camera, SolWaterBody ocean, SolWaterQualityProfile quality)
        {
            ...
            // A very shallow water-shaded skirt closes sub-vertex T-junctions between
            // adjacent LODs. Deep skirts read as vertical water cliffs at the waterline.
            EnsureMesh(quality.clipmapPatchResolution, 0.04f);
